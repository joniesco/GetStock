...
/**
 * Our search page class, will contain a request queue.
 */
...
//        stringRequest.setTag(TAG_SEARCH_NAME);
    ...
    private StringRequest searchNameStringRequest(String nameSearch) {
        ...
        String test_url = "https://jsonplaceholder.typicode.com/todos/1";
        ...
        return new StringRequest(Request.Method.GET, test_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            JSONObject result = new JSONObject(response).getJSONObject("userId");
...
//                            JSONArray resultList = result.getJSONArray("item");
                            ...
                            Toast.makeText(SearchPage.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    } // public void onResponse(String response)
                },
              ...
              new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(SearchPage.this, "Food source is not responding (USDA API)", Toast.LENGTH_LONG).show();
                    }
                });
    }
}
